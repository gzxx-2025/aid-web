<template>
  <a-modal
    ...
    wrap-class-name="create-flow-modal scene-setting-modal-wrap"
    @cancel="handleCancel"
  >
    <div class="setting-modal-shell">
      <header class="setting-modal-header">
        ...
        <button type="button" class="setting-modal-close" aria-label="关闭" @click="handleCancel">
          <CloseOutlined />
        </button>
      </header>
    ...
    <div class="modal-footer">
      ...
      <a-button v-else type="primary" @click="handleSaveOnly">
        {{ primarySyncLabel }}
      </a-button>
    </div>
    </div>
...
.script-editor :deep(.rich-text-editor) {
  height: 100%;
  min-height: 0;
}

.script-editor :deep(.rich-text-editor__host) {
  height: 100%;
  min-height: 0;
}

.script-editor :deep(.ql-container.ql-snow) {
  height: 100%;
  min-height: 0;
}
...
<!-- Modal teleport 到 body：仅隐藏 Ant 默认头，高度由内层 setting-modal-shell 控制 -->
<style lang="scss">
.ant-modal-wrap.scene-setting-modal-wrap .ant-modal.scene-setting-modal .ant-modal-content {
  padding: 0 !important;
  overflow: hidden;
}

.ant-modal-wrap.scene-setting-modal-wrap .ant-modal.scene-setting-modal .ant-modal-header {
  display: none !important;
}

.ant-modal-wrap.scene-setting-modal-wrap .ant-modal.scene-setting-modal .ant-modal-body {
  padding: 0 !important;
}
</style>
