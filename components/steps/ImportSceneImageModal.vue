<template>
  <a-modal
    ...
    wrap-class-name="create-flow-modal import-scene-image-modal-wrap"
    @cancel="handleCancel"
  >
    <div class="import-scene-shell">
      <header class="import-scene-header">
        <ModalTitleWatermark :title="props.title" watermark="IMPORT" />
        <button type="button" class="import-scene-close" aria-label="关闭" @click="handleCancel">
          <CloseOutlined />
        </button>
      </header>
      ...
      <div class="import-content">
        <div v-if="loading" class="import-empty">
          <img src="@/assets/img/icon/no_data.svg" alt="">
        ...
        <div v-else class="import-empty">
          <img src="@/assets/img/icon/empty_icon.svg" alt="">
...
<style lang="scss">
.ant-modal-wrap.import-scene-image-modal-wrap .ant-modal.import-scene-image-modal .ant-modal-content {
  padding: 0 !important;
  overflow: hidden;
  border-radius: 12px;
  background: #191a1d;
...
.ant-modal-wrap.import-scene-image-modal-wrap .ant-modal.import-scene-image-modal .ant-modal-header {
  display: none !important;
}

.ant-modal-wrap.import-scene-image-modal-wrap .ant-modal.import-scene-image-modal .ant-modal-body {
  padding: 0 !important;
  background: #191a1d;
}
</style>
