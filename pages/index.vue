  ...
  <div class="home-legacy-page">
    <div class="page-content">
      <section class="hero-section">
        <div class="hero-bg">
          <img src="../assets/img/home/banner.png" alt="Hero Background" class="hero-bg-img" />
        </div>
        <div class="hero-content">
          <div class="hero-buttons">
            ...
            <button type="button" class="btn-secondary" @click="openTutorial">
          ...
          >
            ...
            <div class="work-info">
              ...
              <div class="work-author">
                ...
                <span class="author-name">{{ work.authorName || '作者' }}</span>
              </div>
            </div>
          </div>
        </div>
